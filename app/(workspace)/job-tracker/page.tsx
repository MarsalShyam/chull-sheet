    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-1">
            Stay structured in your job hunt, manage timelines, and build company-specific preparation guides.
          </p>
        </div>
      ...
      {isAddOpen && (
        <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-slate-900 border border-slate-800 rounded-xl max-w-lg w-full p-6 shadow-2xl relative my-8 animate-in fade-in zoom-in-95 duration-200">
            <button
            ...
            <h3 className="text-base font-bold text-slate-100 mb-4">Track Job Application</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-855 rounded-lg px-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-indigo-500 cursor-pointer"
                  >
                    {STAGES.map((s) => (
              ...
              <div className="border-t border-slate-850 pt-4 space-y-3">
                <h4 className="text-xs font-bold text-slate-300">Preparation Q&A Questions</h4>
                
                {questions.length > 0 && (
                  <div className="space-y-2 bg-slate-950 p-3 rounded-lg border border-slate-850">
                    {questions.map((q) => (
                      <div key={q.id} className="flex justify-between items-start text-[11px] border-b border-slate-850/60 pb-1.5 last:border-0 last:pb-0">
                        <div>
                          <p className="font-bold text-slate-300">Q: {q.question}</p>
                          <p className="text-slate-400 mt-0.5">A: {q.answer}</p>
                        </div>
                        <button
                          type="button"
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-[10px] font-bold text-indigo-400 hover:text-indigo-300 cursor-pointer"
                  >
                    + Add QA Item
                  </button>
                </div>
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-xs font-semibold text-white cursor-pointer"
                >
                  Create Application
                </button>
              </div>
